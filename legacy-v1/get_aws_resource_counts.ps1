...
$resourceTypes = @{
    "Non-Compute" = @{
        ...
        "AWS::DirectConnect::Connection"           = "Get-DCConnection"
        "AWS::DirectConnect::VirtualInterface"     = "Get-DCVirtualInterface"
        "AWS::GlobalNetworks::Network"            = "Get-NMGRGlobalNetwork"
    }
    "IaaS"        = @{
    ...
    "PaaS"        = @{
        ...
        "AWS::EKS::Cluster"                     = "Get-EKSClusterList"
        ...
        "AWS::RedshiftServerless::Workgroup"    = "Get-RSSWorkgroupList"
        "AWS::RDS::DBInstance"                  = "Get-RDSDBInstance"
        "AWS::QBusiness::Application"           = "Get-QBUSApplicationList"
    }
}
